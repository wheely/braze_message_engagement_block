...
view: email_messaging_cadence {
  derived_table: {
    sql: with deliveries as
      ...
      from BRAZE.PASSENGERS_MESSAGES_EMAIL_DELIVERY group by 1,2,3,4,5,6,7),
      ...
      FROM BRAZE.PASSENGERS_MESSAGES_EMAIL_OPEN),
      ...
      FROM BRAZE.PASSENGERS_MESSAGES_EMAIL_CLICK)
